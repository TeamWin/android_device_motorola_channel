...
BOARD_SUPER_PARTITION_GROUPS := moto_system_dynamic_partitions moto_vendor_dynamic_partitions
BOARD_MOTO_SYSTEM_DYNAMIC_PARTITIONS_PARTITION_LIST := system
BOARD_MOTO_VENDOR_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    odm \
    vendor

BOARD_SUPER_PARTITION_SIZE := 3076521984                       # 3087007744 - 10485760 10MB overhead
...
BOARD_MOTO_SYSTEM_DYNAMIC_PARTITIONS_SIZE := 2466250752        #   SYSTEM
BOARD_MOTO_VENDOR_DYNAMIC_PARTITIONS_SIZE := 620756992		   #      OEM + VENDOR
